...
"""autogenerated by genpy from tsane_mmlamare_mwpiazza_final/AStarRequest.msg. Do not edit."""
import sys
...
class AStarRequest(genpy.Message):
  _md5sum = "b79743745ad6d02fe7b0fadd29455166"
  _type = "tsane_mmlamare_mwpiazza_final/AStarRequest"
...
float64 w
"""
  __slots__ = ['frameID','map','costMap','start']
  _slot_types = ['std_msgs/String','nav_msgs/OccupancyGrid','nav_msgs/OccupancyGrid','geometry_msgs/Pose']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_7d.pack(_x.start.position.x, _x.start.position.y, _x.start.position.z, _x.start.orientation.x, _x.start.orientation.y, _x.start.orientation.z, _x.start.orientation.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.start.position.x, _x.start.position.y, _x.start.position.z, _x.start.orientation.x, _x.start.orientation.y, _x.start.orientation.z, _x.start.orientation.w,) = _struct_7d.unpack(str[start:end])
      return self
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from tsane_mmlamare_mwpiazza_final/AStarResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class AStarResponse(genpy.Message):
  _md5sum = "484715875d5f6b889af78f85d6cd9fdb"
  _type = "tsane_mmlamare_mwpiazza_final/AStarResponse"
  _has_header = False #flag to mark the presence of a Header object
...
float64 w
"""
  __slots__ = ['waypoints','frontierExplored']
  _slot_types = ['nav_msgs/Path','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.frontierExplored is None:
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_B.pack(self.frontierExplored))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.frontierExplored,) = _struct_B.unpack(str[start:end])
      self.frontierExplored = bool(self.frontierExplored)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
class AStar(object):
  _type          = 'tsane_mmlamare_mwpiazza_final/AStar'
  _md5sum = '83917d80c2c524ed3baa8ca42ce18e66'
