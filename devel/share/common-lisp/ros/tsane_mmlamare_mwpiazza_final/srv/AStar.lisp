...
(cl:defmethod goal-val ((m <AStar-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tsane_mmlamare_mwpiazza_final-srv:goal-val is deprecated.  Use tsane_mmlamare_mwpiazza_final-srv:goal instead.")
  (goal m))
